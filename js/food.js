function menuu(){
		...
		//
		var foodArray = ['00_2','01_2','02_2','03_2','04_2','05_2','06_2','07_2','08_2','09_2','10_2','12_2','13_2','14_2','15_2','16_2','17_2','11'];
		...
		//
		var collumn = 0;
		var picTotal = foodArray.length;
		while(foodArray.length != 0){
			loadImage();
		}
		function loadImage(){
			var lengthh = foodArray.length;
			//var randomm = Math.floor(Math.random(picTotal) * lengthh);
			var categoryy ='Food';
			var thumbb = foodArray[0];
			var indexx = 0;
			var orrient = orientt(thumbb,foodArray,indexx);;
			var innHtml='';
		...
		if(isMobile){
			var floatNone = document.getElementsByClassName('mainContents')[0].getElementsByTagName('div');
			for(i=0;i<floatNone.length;i++){
				floatNone[i].style.float = 'none';
			};
		}
	}
